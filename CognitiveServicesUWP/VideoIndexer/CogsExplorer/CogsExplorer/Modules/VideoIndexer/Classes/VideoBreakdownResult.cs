...
namespace CogsExplorer.Modules.VideoIndexer
{
    ...
    public class Ocr
    {
        ...
        public Adjustedtimerange2 adjustedTimeRange { get; set; }
    ...
    {
        public int id { get; set; }
        public Timerange5 timeRange { get; set; }
        public string keyFrame { get; set; }
    }
    ...
    {
        public string name { get; set; }
        public Timerange6[] timeRanges { get; set; }
        public Adjustedtimerange3[] adjustedTimeRanges { get; set; }
    }

    public class Timerange6
    {
        public string start { get; set; }
        public string end { get; set; }
    }

    public class Adjustedtimerange3
    {
        public string start { get; set; }
        public string end { get; set; }
    }
