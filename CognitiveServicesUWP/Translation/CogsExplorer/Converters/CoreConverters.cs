...
{
    public sealed class TranslationLanguageLabelConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, string language)
        {   
            var translation = value as Modules.Translation.TranslationInformation;

            return $"Translated to {translation.TranslatedLanguage.DisplayName}\r\n({translation.OriginalContent})";
        }
